<!--shows agricultural products in Sales by product-->
...
<div class="btn-group">
  <a class="button" href="salesAgriPrint.php"  target="_blank"><span class="glyphicon glyphicon-print"> Print</span>
  </a>
                    ...
                    if($result = mysqli_query($conn, $sql)){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<center><table class='table'></center>"; 
                                ...
                                echo "<thead>";
                                echo "<caption><h1>Sales By Product (Agricultural Products)</h1></caption>";
