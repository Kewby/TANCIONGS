<!--shows non-agricultural products in Product Master List-->
...
<div class="btn-group">
  <a class="button" href="productNonAgriPrint.php"  target="_blank"><span class="glyphicon glyphicon-print"> Print</span>
...
<div class="btn-group">
  <a class="btn dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-search"> Filter By Product Type:</span>
    <span class="caret"></span>
  </a>
  <ul class="dropdown-menu">
  <li><a href="agriculturalProduct.php">Agricultural Products</a></li>
   <li><a href="nonAgriculturalProduct.php">Non-Agricultural Products</a></li>
                    ...
                    if($result = mysqli_query($conn, $sql)){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<center><table class='table'></center>";
                                ...
                                echo "<thead>";
                                echo "<caption><h1>Product Master List Report (Non-Agricultural Products)</h1></caption>";
