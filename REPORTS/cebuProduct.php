<!--shows cebu branch products in Product Master List-->
...
<div class="btn-group">
  <a class="button" href="cebuProductPrint.php"  target="_blank"><span class="glyphicon glyphicon-print"> Print</span>
  </a>
                    ...
                    if($result = mysqli_query($conn, $sql)){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<center><table class='table'></center>";
                                ...
                                echo "<thead>";
                                echo "<caption><h1>Product Master List Report (Cebu Branch)</h1></caption>";
