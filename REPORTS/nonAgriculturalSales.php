<!--shows non-argricultural products in Sales report-->
...
<div class="btn-group">
  <a class="button" href="salesNonAgriPrint.php"  target="_blank"><span class="glyphicon glyphicon-print"> Print</span>
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu">
   <li><a href="agriculturalSales.php">Agricultural</a></li>
   <li><a href="nonAgriculturalSales.php">Non-Agricultural</a></li>
                    ...
                    if($result = mysqli_query($conn, $sql)){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<center><table class='table'></center>"; 
                                ...
                                echo "<thead>";
                                echo "<caption><h1>Sales By Product (Non- Agricultural Products)</h1></caption>";

                                    echo "<tr style='width: 100px;'>";


                                           echo "<th style='width: 150px;'>Transaction Item ID</th>";
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td> ", "<center>". $row['transactionItem_id'] . "</center>", "</td>";
