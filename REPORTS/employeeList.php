<!--query for showing price master list-->
...
<div class="btn-group">
  <a class="button" href="employeePrint.php"  target="_blank"><span class="glyphicon glyphicon-print"> Print</span>
  </a>
                    ...
                    if($result = mysqli_query($conn, $sql)){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<center><table class='table'></center>";
                                ...
                                echo "<thead>";
                                echo "<caption><h1>Employee Master List</h1></caption>";
                                    ...
                                    echo "<tr style='width: 100px;'>";
                                        ...
                                        echo "<th>Tin Number</th>";
                                         ...
                                         echo "<th> Phil Health</th>";

                                        echo "<th>SSS Number</th>";
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td> ", "<center>". $row['employee_username'] . "</center>","</td>";
                                        ...
                                        echo "<td> ", "<center>". $row['employee_tinNumber'] . "</center>", "</td>";

                                        echo "<td> ", "<center>". $row['employee_philHealth'] . "</center>","</td>";

                                        
                                        echo "<td> ", "<center>". $row['employee_sssNumber'] . "</center>", "</td>";
                                        ...
                                        echo "<td> ", "<center>". $row['role_name'] . "</center>","</td>";
