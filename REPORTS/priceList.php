...
<div class="btn-group">
  <a class="button" href="pricePrint.php"  target="_blank"><span class="glyphicon glyphicon-print"> Print</span>
  </a>
...
<?php
                    ...
                    $sql = "SELECT  product.product_id, product.product_code, product.product_name, product.product_type, product.list_price, category.category_id, category.category_name
                    ...
                    if($result = mysqli_query($conn, $sql)){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<center><table class='table'></center>";
                                ...
                                echo "<thead>";
                                echo "<caption><h1>Price List Report</h1></caption>";

                                    echo "<tr style='width: 100px;'>";

                                        echo "<th style='width: 150px;'>Product code</th>";
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td> ", "<center>". $row['list_price'] . "</center>", "</td>";
