...
class myPDF extends FPDF{
	...
	$this->Cell(276,10,'Product Master List', 0, 0, 'C');
	$this->Ln(20);
	}
	function footer(){
	$this->SetY(-15);
...
function viewTable($db){
	...
	$stmt= $db->query("SELECT   product.product_id, product.product_code, product.product_name, product.product_type, product.restockCount, category.category_id, category.category_name, branch.branch_id, branch.branch_name,product.deleteStatus, 
