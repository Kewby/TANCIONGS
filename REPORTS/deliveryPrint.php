...
if(isset($_SESSION['start']) && isset($_SESSION['end'])){ 
						$stringQuery1 = "SELECT  delivery.delivery_id, delivery.dateDelivered, product.product_id, product.product_name, product.product_code, delivery.delivery_quantity, supplier.supplier_id, supplier.supplier_name,employee.employee_id, employee.employee_firstname, delivery.expiry_date, branch.branch_id, branch.branch_name
                    ...
                    AND delivery.dateDelivered >= '$_SESSION[start]'
            AND delivery.dateDelivered <= '$_SESSION[end]' 
  ...
  $sum_sales= 0;   
	...
	$this->Ln();
 						...
 						$stringQuery = "SELECT  delivery.delivery_id, delivery.dateDelivered, product.product_id, product.product_name, product.product_code, delivery.delivery_quantity, supplier.supplier_id, supplier.supplier_name,employee.employee_id, employee.employee_firstname, delivery.expiry_date, branch.branch_id, branch.branch_name
