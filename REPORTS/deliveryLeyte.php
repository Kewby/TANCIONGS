<!--shows delivery Report leyte branch-->
...
<div class="btn-group">
  <a class="button" href="deliveryLeytePrint.php"  target="_blank" ><span class="glyphicon glyphicon-print"> Print</span>
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu">
   <li><a href="deliveryCebu.php">Cebu Branch</a></li>
    <li><a href="deliveryLeyte.php">Leyte Branch</a></li>
                       ...
                       if($result = mysqli_query($conn, $sql)){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<center><table class='table'></center>";
                                ...
                                echo "<thead>";
                                echo "<caption><h1>Delivery Report(Leyte Branch)</h1></caption>";
