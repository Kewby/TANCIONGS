<!--shows delivery Report cebu branch-->
...
<div class="btn-group">
  <a class="button" href="deliveryCebuPrint.php"  target="_blank" ><span class="glyphicon glyphicon-print"> Print</span>
                       ...
                       if($result = mysqli_query($conn, $sql)){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<center><table class='table'></center>";
                                ...
                                echo "<thead>";
                                echo "<caption><h1>Delivery Report(Cebu Branch)</h1></caption>";
