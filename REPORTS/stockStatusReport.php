...
<!--<div class="btn-group">
  ...
  <ul class="dropdown-menu">
  <li><a href="stockStatus.php">Status</a></li>-->
...
<?php
                    ...
                    $sql = "SELECT  stock.stock_id, stock.stock_onhand,  product.restockCount, product.product_id, product.product_name, product.product_code
                                ...
                                echo "<caption><h1>Stock Status Report</h1></caption>";
                                    ...
                                    echo "<tr style='width: 100px;'>";
                                        ...
                                        echo "<th>Stock Onhand</th>";
                                         ...
                                         echo "<th>Restock Count</th>";

                                         echo "<th>Poduct Code</th>";
...
$stockOnHand= $row['stock_onhand'];
$restock= $row['restockCount'];
$status= "";

if($stockOnHand <= $restock)
  ...
  $status= 'Available';
                           ...
                           //print_r($row); 
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td> ","<center>". $row['restockCount'] . "</center>","</td>";
