...
<?php
                   ...
                   $sql = "SELECT   product.product_id, product.product_code, product.product_name, category.category_id, category.category_name, branch.branch_id, product.deleteStatus, branch.branch_name, product.product_type,

                   CASE WHEN product.deleteStatus = 1 THEN 'Phaseout' ELSE 'Available' END AS deleteStatus,
                            ...
                            echo "<center><table class='table'></center>";
                                ...
                                echo "<caption><h1>Product Master List Report</h1></caption>";
                                    ...
                                    echo "<tr style='width: 100px;'>";
                                        ...
                                        echo "<th style='width: 150px;'><a href='productMasterList.php'>Product Id</a></th>";

                                        echo "<th><a href='productMasterList.php'>Product Code</a></th>";

                                        echo "<th><a href='productMasterList.php'>Product Name</a></th>";

                                        echo "<th><a href='productMasterList.php'>Product Type</a></th>";

                                       
                                         echo "<th><a href='productMasterList.php'>Category Name</a></th>";

                                        echo "<th><a href='productMasterList.php'>Branch</a></th>";

                                        echo "<th><a href='productMasterList.php'>Status</a></th>";
